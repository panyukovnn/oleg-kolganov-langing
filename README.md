...
Раздел статей обновлен в редакции r23: 130 материалов в восьми рубриках, с поиском и оглавлениями. Актуальная структура и порядок обновления описаны в [maintenance/articles.md](maintenance/articles.md). Старые инструкции массового зеркалирования ниже не используются для обновления этого раздела.
...
│   ├── articles/               # каталог и поиск по 130 статьям
